...
class ShiftRegister
{
    ...
    //=========================================================================
    //=========================================================================
    public function OpenLatchPin(Array $args=[])
    {
        $this->latch_pin_open = 1;
        return GPIO::PinWrite($this->latch_pin, 1, $args);
    }
    ...
    //=========================================================================
    //=========================================================================
    public function CloseLatchPin(Array $args=[])
    {
        $this->latch_pin_open = 0;
        return GPIO::PinWrite($this->latch_pin, 0, $args);
    }
    ...
    //=========================================================================
    //=========================================================================
    public function IsLatchPinOpen()
    {
        return $this->latch_pin_open;
    }
}
